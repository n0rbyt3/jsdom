...
class XMLHttpRequestImpl extends XMLHttpRequestEventTargetImpl {
  ...
  getAllResponseHeaders() {
    ...
    return Object.keys(properties.responseHeaders)
      ...
      .map(key => [key, properties.responseHeaders[key]].join(": "))
      .join("\r\n");
  }
  ...
  getResponseHeader(header) {
    ...
    if (properties.filteredResponseHeaders.find(filtered => lcHeader === filtered)) {
      return null;
    }
